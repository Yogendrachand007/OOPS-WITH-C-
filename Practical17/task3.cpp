...
{
    map<int, string> m;
    m.insert(pair<int, string>(4, "Yogendra"));
    m.insert(pair<int, string>(8, "Chand"));
    m.insert(pair<int, string>(1, "Neha"));
    m.insert(pair<int, string>(5, "Mohit"));
    m.insert(pair<int, string>(2, "Shubham"));
    m.insert(pair<int, string>(5, "Rohit"));
    m.insert(pair<int, string>(3, "Himanshi"));
